...
struct Test {
    ...
    @Test func test95_115_part2() async throws {
        let ids = Day02.IDRange(range: 95...115).invalidIDsPart2
        #expect(ids == [99, 111])
    }
    
    @Test func sampleRanges_part2() async throws {
        let rangesAndAnswers: [ClosedRange<Int>: [Int]] = [
            (11...22) : [11, 22],
            (95...115) : [99, 111],
            (998...1012) : [999, 1010],
        ...
        for (range, expectedIDs) in rangesAndAnswers {
            let ids = Day02.IDRange(range: range).invalidIDsPart2
            #expect(ids.sorted() == expectedIDs)
        }
    }
    ...
    @Test func testRepeatDigits() async throws {
        #expect(13.repeatDigits(3) == 131313)
    }
